...
class AppInput extends StatefulWidget {
  ...
  const AppInput({super.key,this.validator,this.controller,this.isEnabled=true,required this.labelText,required this.icon,this.paddingBottom=16,this.paddingTop=16,this.isPhone=false,this.isPassword=false});
